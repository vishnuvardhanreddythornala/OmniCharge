            ...
            <div class="animate-slide-up">
              ...
              <div class="flex items-center gap-6 mt-10">
                <div class="flex items-center gap-2">
                  <div class="w-8 h-8 rounded-lg bg-surface-100 flex items-center justify-center border border-surface-200">
                  ...
                  <span class="text-xs font-medium text-surface-600">Razorpay Secured</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-8 h-8 rounded-lg bg-surface-100 flex items-center justify-center border border-surface-200">
                    <svg class="w-4 h-4 text-surface-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span class="text-xs font-medium text-surface-600">Instant Activation</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-8 h-8 rounded-lg bg-surface-100 flex items-center justify-center border border-surface-200">
                    <svg class="w-4 h-4 text-surface-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span class="text-xs font-medium text-surface-600">All Operators</span>
                </div>
              </div>
            </div>
            ...
            <div class="animate-slide-up" style="animation-delay: 0.15s">
              <div class="glass-card p-6 sm:p-8 relative overflow-hidden">
                ...
                <div class="relative">
                  ...
                  <!-- Mobile Number Input -->
                  <div class="relative mb-4 group/input">
...
export class LandingComponent implements OnInit {
  ...
  steps = [
    { num: 1, icon: '📱', title: 'Enter Number', desc: 'Type any mobile number. We auto-detect the operator instantly using Numverify.', gradient: 'from-surface-100 to-surface-50' },
    { num: 2, icon: '📋', title: 'Choose a Plan', desc: 'Browse curated plans by category — Popular, Data, Unlimited, Talktime.', gradient: 'from-surface-100 to-surface-50' },
    { num: 3, icon: '✅', title: 'Pay & Done', desc: 'Pay securely with Razorpay. Your recharge is activated within seconds.', gradient: 'from-surface-100 to-surface-50' },
  ];

  features = [
    { icon: '🔍', title: 'Auto Operator Detection', desc: 'Just enter a number — we identify the operator instantly.', bg: 'bg-surface-100 border border-surface-200' },
    { icon: '⚡', title: 'Instant Activation', desc: 'Recharges go live within seconds of payment.', bg: 'bg-surface-100 border border-surface-200' },
    { icon: '🔒', title: 'Razorpay Secured', desc: 'Enterprise-grade payment security with Razorpay.', bg: 'bg-surface-100 border border-surface-200' },
    { icon: '📊', title: 'Transaction History', desc: 'Track every recharge and payment in your dashboard.', bg: 'bg-surface-100 border border-surface-200' },
    { icon: '🔔', title: 'Smart Notifications', desc: 'Get notified about recharge status and receipts.', bg: 'bg-surface-100 border border-surface-200' },
    { icon: '🌐', title: 'All Operators', desc: 'Supports Jio, Airtel, Vi, BSNL, and more.', bg: 'bg-surface-100 border border-surface-200' },
  ];
