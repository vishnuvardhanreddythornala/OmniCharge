  ...
  template: `
    <div class="space-y-6 animate-fade-in pb-10">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-display font-bold text-surface-900">Admin Profile Options</h1>
          <p class="text-surface-500 text-sm mt-1">Manage your administrative credentials and personal details.</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="glass-card p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 class="text-lg font-bold text-surface-900">General Information</h3>
              <p class="text-sm text-surface-500">Update your account name.</p>
            </div>
          </div>
        ...
        <div class="glass-card p-6">
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 class="text-lg font-bold text-surface-900">Account Overview</h3>
              <p class="text-sm text-surface-500">Your admin account details.</p>
            </div>
          </div>
          ...
          <div class="space-y-4">
            <div class="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="text-sm font-medium text-surface-900">Account Status</p>
            ...
            <div class="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="text-sm font-medium text-surface-900">Role</p>
            ...
            <div class="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="text-sm font-medium text-surface-900">Support</p>
