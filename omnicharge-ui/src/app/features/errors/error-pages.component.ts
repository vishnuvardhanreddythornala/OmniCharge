  ...
  template: `
    <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      <div class="text-center animate-slide-up max-w-md">
        ...
        <h1 class="text-2xl font-bold text-surface-900 mb-3">Access Denied</h1>
        <p class="text-surface-500 mb-8 text-sm leading-relaxed">
  ...
  template: `
    <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      <div class="text-center animate-slide-up max-w-md">
        ...
        <h1 class="text-2xl font-bold text-surface-900 mb-3">Page Not Found</h1>
        <p class="text-surface-500 mb-8 text-sm leading-relaxed">
  ...
  template: `
    <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      <div class="text-center animate-slide-up max-w-md">
        ...
        <h1 class="text-2xl font-bold text-surface-900 mb-3">Server Error</h1>
        <p class="text-surface-500 mb-8 text-sm leading-relaxed">
