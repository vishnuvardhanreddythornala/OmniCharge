...
@WebMvcTest(controllers = AuthController.class, excludeAutoConfiguration = { JpaRepositoriesAutoConfiguration.class,
...
class AuthControllerTest {
        ...
        void login_Success() throws Exception {
                ...
                req.setEmail("vishnuvardhanreddythornala@gmail.com");
                req.setPassword("pass");

                AdminLoginInitResponse initResponse = AdminLoginInitResponse.builder()
                                .requires2fa(true).email("vishnuvardhanreddythornala@gmail.com").build();
