    ...
    public OpenAPI paymentServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("""
                                Handles all payment processing via Razorpay, transaction tracking, and admin analytics.
                                
                                **Features:**
                                - Initiate and confirm payments via Razorpay
                                - Webhook handlers for payment confirmation/failure
                                - Server-side payment verification fallback
                                - User payment history (paginated, filtered)
                                - Admin: global transaction view and stats
                                """)
                        .version("v1.0.0")
