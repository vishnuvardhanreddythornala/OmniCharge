-- UPDATE existing Operators with logos
UPDATE operators SET logo_url = 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Airtel_logo.svg' WHERE code = 'AIRTEL';
UPDATE operators SET logo_url = 'https://upload.wikimedia.org/wikipedia/commons/4/43/Jio_logo_%282021%29.svg' WHERE code = 'JIO';
UPDATE operators SET logo_url = 'https://upload.wikimedia.org/wikipedia/commons/2/27/Vi_logo.svg' WHERE code = 'VI';
UPDATE operators SET logo_url = 'https://upload.wikimedia.org/wikipedia/commons/c/c5/BSNL_logo.svg' WHERE code = 'BSNL';

-- Clear existing plans or just insert more since the image shows test packs
-- Seed Plans for Jio
